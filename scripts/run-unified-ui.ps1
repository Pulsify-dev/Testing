...
# 1. Pulsify Environment Variables (Modules 1-12)
...
Write-Host "   PULSIFY E2E - MODULES 1-12 (UI MODE)         " -ForegroundColor Green
Write-Host "=================================================" -ForegroundColor Cyan
